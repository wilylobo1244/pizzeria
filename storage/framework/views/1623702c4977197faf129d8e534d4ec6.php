                ...
                <table id="tabla-empleados" class="w-full">
                    ...
                    <tbody>
                        <?php $__currentLoopData = $datosEmpleado; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dato): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="border-b">
                                <td class="py-2"><?php echo e($dato->usuario->nombre); ?></td>
                                <td class="py-2"><?php echo e($dato->usuario->usuario); ?></td>
                                <td class="py-2"><?php echo e($dato->usuario->rol->nombre_rol); ?></td>
                                <td class="py-2"><?php echo e($dato->fecha_contratacion); ?></td>
                                <?php if( $dato->estatus_empleado == 1 ): ?>
                                    <td class="py-2">Activo</td>
                                <?php else: ?>
                                    <td class="py-2">Inactivo</td>
                                <?php endif; ?>
                                <td class="text-right py-2">
                                    <a href="<?php echo e(route('empleado.datosParaEdicion', $dato->empleado_pk)); ?>" class="bg-blue-500 text-white px-2 py-1 rounded mr-2">Editar</a>

                                    <?php if($dato->estatus_empleado == 1 & $dato->usuario->estatus_usuario == 1): ?>
                                        <a href="<?php echo e(route('empleado.baja', $dato->empleado_pk)); ?>" onclick="confirmarBaja(event)" class="bg-red-500 text-white px-2 py-1 rounded">Dar de baja</a>
                                    <?php else: ?>
                                        <a href="<?php echo e(route('empleado.alta', $dato->empleado_pk)); ?>" onclick="confirmarAlta(event)" class="bg-green-500 text-white px-2 py-1 rounded">Dar de alta</a>
                                    <?php endif; ?>
                                </td>
                            </tr>
            ...
            <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
                <div class="mt-3 text-center">
                    ...
                    <div class="mt-2 px-7 py-3">
                        ...
                        <form id="form-empleado" action="<?php echo e(route('empleado.insertar')); ?>" method="post">
                            <?php echo csrf_field(); ?>
                            <div class="mb-4">
                            ...
                            <div class="mb-4">
                                ...
                                <select name="rol_fk" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" required>
                                    ...
                                    <?php $__currentLoopData = $datosRol; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dato): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($dato->rol_pk); ?>"><?php echo e($dato->nombre_rol); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                            <div class="mb-4">
                                ...
                                <input type="date" id="fecha_contratacion" name="fecha_contratacion" value="<?php echo e(Carbon::now()->format('Y-m-d')); ?>" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" required>
                            </div>
...
</html><?php /**PATH C:\Users\Usuario\Downloads\SGN_Monalezza-main\SGN_Monalezza-main\resources\views/empleados.blade.php ENDPATH**/ ?>