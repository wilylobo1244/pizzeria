    ...
    <div class="h-screen flex flex-col">
        ...
        <div class="flex-grow overflow-y-auto p-4">
            ...
            <div class="bg-white shadow-md rounded-lg p-4">
                <form action="<?php echo e(route('empleado.actualizar', $datosEmpleado->empleado_pk)); ?>" method="post">
                    <?php echo csrf_field(); ?>
                    <?php echo method_field('put'); ?>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div class="mb-4">
                            <label for="nombre" class="block text-sm font-medium text-gray-700">Nombre</label>
                            <input type="text" id="nombre" name="nombre" value="<?php echo e($datosEmpleado->usuario->nombre); ?>"
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" id="usuario" name="usuario"
                                value="<?php echo e($datosEmpleado->usuario->usuario); ?>"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                        </div>
                        <div class="mb-4">
                        ...
                        <div class="mb-4">
                            ...
                            <select name="rol_fk"
                                ...
                                <option <?php if($dato->rol_fk == $datosEmpleado->rol_pk): ?> selected <?php endif; ?> value="<?php echo e($dato->rol_pk); ?>"><?php echo e($dato->nombre_rol); ?></option>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="date" id="fecha_contratacion" name="fecha_contratacion"
                                value="<?php echo e($datosEmpleado->fecha_contratacion); ?>"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                        </div>
                    </div>
...
</html><?php /**PATH C:\Users\Usuario\Downloads\SGN_Monalezza-main\SGN_Monalezza-main\resources\views/editarEmpleado.blade.php ENDPATH**/ ?>