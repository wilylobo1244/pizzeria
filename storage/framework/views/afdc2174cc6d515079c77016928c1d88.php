        ...
        <div class="flex-grow overflow-y-auto p-4">
            ...
            <div class="bg-white shadow-md rounded-lg p-4 mb-10">
                ...
                <div data-modal="modal-filtros" style="display: none;" class="fixed inset-0 bg-black bg-opacity-50 items-center justify-center z-50 flex">
                    <div class="bg-white w-full max-w-md rounded-lg shadow-lg p-6 relative">
                        ...
                        <form action="<?php echo e(route('pedido.filtrar')); ?>" method="GET" class="space-y-4">
                            <div>
                            ...
                            <div>
                                ...
                                <select id="estatus" name="estatus"
                                    ...
                                    <option value="1" <?php echo e(request('estatus') == '1' ? 'selected' : ''); ?>>Pendiente</option>
                                    <option value="0" <?php echo e(request('estatus') == '0' ? 'selected' : ''); ?>>Entregado</option>
                                    <option value="2" <?php echo e(request('estatus') == '2' ? 'selected' : ''); ?>>Cancelado</option>
                                </select>
                            </div>
                            ...
                            <div class="flex justify-between items-center pt-2">
                                ...
                                <a href="<?php echo e(route('pedido.mostrar')); ?>" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded">
                                    Quitar filtros
                                </a>
                ...
                <table id="tabla-pedidos" class="w-full">
                    ...
                    <tbody>
                        <?php $__currentLoopData = $datosPedido; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dato): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="border-b cursor-pointer" title="CLIC PARA VER DETALLES" data-detalles='<?php echo json_encode($dato->detalle_pedido, 15, 512) ?>'>
                                <td class="py-2"><?php echo e($dato->pedido_pk); ?></td>
                                <td class="py-2"><?php echo e($dato->cliente->nombre_cliente ?? 'Cliente genérico'); ?></td>
                                <td class="py-2"><?php echo e($dato->empleado->usuario->usuario); ?></td>
                                <td class="py-2"><?php echo e($dato->fecha_hora_pedido); ?></td>
                                <td class="py-2"><?php echo e($dato->medio_pedido->nombre_medio_pedido); ?></td>
                                <td class="py-2">$<?php echo e($dato->monto_total); ?></td>
                                <td class="py-2"><?php echo e($dato->tipo_pago->nombre_tipo_pago); ?></td>
                                <?php if( $dato->numero_transaccion ): ?>
                                    <td class="py-2"><?php echo e($dato->numero_transaccion); ?></td>
                                <?php else: ?>
                                    <td class="py-2"><em>Sin número de transacción</em></td>
                                <?php endif; ?>
                                <?php if( $dato->notas_remision ): ?>
                                    <td class="py-2"><?php echo e($dato->notas_remision); ?></td>
                                <?php else: ?>
                                    <td class="py-2"><em>Sin notas de remisión</em></td>
                                <?php endif; ?>
                                <?php if( $dato->estatus_pedido == 1 ): ?>
                                    <td class="py-2">Pendiente</td>
                                <?php elseif( $dato->estatus_pedido == 0 ): ?>
                                    <td class="py-2">Entregado</td>
                                <?php elseif( $dato->estatus_pedido == 2 ): ?>
                                    <td class="py-2">Cancelado</td>
                                <?php else: ?>
                                    <td class="py-2"><em>Sin estatus aplicado</em></td>
                                <?php endif; ?>
                                <td class="text-right py-2">
                                    <button onclick="abrirTicket(<?php echo e($dato->pedido_pk); ?>)" class="bg-gray-500 text-white px-2 py-1 rounded fix">Ticket</button>
                                </td>
                                <td class="text-right py-2">
                                    <?php if( $dato->estatus_pedido == 1 ): ?>
                                        <a href="<?php echo e(route('pedido.entregado', $dato->pedido_pk)); ?>" onclick="confirmarEntrega(event)" class="bg-green-500 text-white px-2 py-1 rounded fix">Entregado</a>
                                        <?php if(  session('rol_pk') == 1): ?>
                                            <a href="<?php echo e(route('pedido.datosParaEdicion', $dato->pedido_pk)); ?>" class="bg-blue-500 text-white px-2 py-1 rounded fix">Editar</a>
                                        <?php endif; ?>
                                    <?php endif; ?>

                                    <?php if( $dato->estatus_pedido != 2 ): ?>
                                        <a href="<?php echo e(route('pedido.cancelado', $dato->pedido_pk)); ?>" onclick="confirmarCancelacion(event)" class="bg-red-500 text-white px-2 py-1 rounded fix">Cancelar</a>
                                    <?php elseif( $dato->estatus_pedido == 2 ): ?>
                                        <a href="<?php echo e(route('pedido.pendiente', $dato->pedido_pk)); ?>" onclick="confirmarDesCancelacion(event)" class="bg-black text-white px-2 py-1 rounded fix">Deshacer cancelación</a>
                                    <?php endif; ?>
                                </td>
                            </tr>
            ...
            <div class="bg-white shadow-md rounded-lg p-4">
                <table id="tabla-tipo-pago" class="w-full">
                    ...
                    <tbody>
                        <?php $__currentLoopData = $datosTipo_pago; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dato): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="border-b cursor-pointer">
                                <td class="py-2"><?php echo e($dato->nombre_tipo_pago); ?></td>
                                <?php if( $dato->estatus_tipo_pago == 1 ): ?>
                                ...
                                <?php if( session('rol_pk') == 1 ): ?>
                                    <td class="text-right py-2">
                                        <a href="<?php echo e(route('tipo_pago.datosParaEdicion', $dato->tipo_pago_pk)); ?>" class="bg-blue-500 text-white px-2 py-1 rounded mr-2">Editar</a>

                                        <?php if($dato->estatus_tipo_pago == 1): ?>
                                            <a href="<?php echo e(route('tipo_pago.baja', $dato->tipo_pago_pk)); ?>" onclick="confirmarBajaTipoPago(event)" class="bg-red-500 text-white px-2 py-1 rounded">Dar de baja</a>
                                        <?php else: ?>
                                            <a href="<?php echo e(route('tipo_pago.alta', $dato->tipo_pago_pk)); ?>" onclick="confirmarAltaTipoPago(event)" class="bg-green-500 text-white px-2 py-1 rounded">Dar de alta</a>
                                        <?php endif; ?>
                                    </td>
                                <?php endif; ?>
                            </tr>
            ...
            <div class="bg-white shadow-md rounded-lg p-4">
                <table id="tabla-medio-pedido" class="w-full">
                    ...
                    <tbody>
                        <?php $__currentLoopData = $datosMedio_pedido; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dato): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="border-b cursor-pointer">
                                <td class="py-2"><?php echo e($dato->nombre_medio_pedido); ?></td>
                                <?php if( $dato->estatus_medio_pedido == 1 ): ?>
                                    <td class="py-2">Activo</td>
                                <?php else: ?>
                                    <td class="py-2">Inactivo</td>
                                <?php endif; ?>
                                <?php if( session('rol_pk') == 1 ): ?>
                                    <td class="text-right py-2">
                                        <a href="<?php echo e(route('medio_pedido.datosParaEdicion', $dato->medio_pedido_pk)); ?>" class="bg-blue-500 text-white px-2 py-1 rounded mr-2">Editar</a>

                                        <?php if($dato->estatus_medio_pedido == 1): ?>
                                            <a href="<?php echo e(route('medio_pedido.baja', $dato->medio_pedido_pk)); ?>" onclick="confirmarBajaMedioPedido(event)" class="bg-red-500 text-white px-2 py-1 rounded">Dar de baja</a>
                                        <?php else: ?>
                                            <a href="<?php echo e(route('medio_pedido.alta', $dato->medio_pedido_pk)); ?>" onclick="confirmarAltaMedioPedido(event)" class="bg-green-500 text-white px-2 py-1 rounded">Dar de alta</a>
                                        <?php endif; ?>
                                    </td>
                                <?php endif; ?>
                            </tr>
            ...
            <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
                <div class="mt-3 text-center">
                    ...
                    <div class="mt-2 px-7 py-3">
                        ...
                        <form id="form-medped" action="<?php echo e(route('medio_pedido.insertar')); ?>" method="post">
                            <?php echo csrf_field(); ?>
                            <div class="mb-4">
            ...
            <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
                <div class="mt-3 text-center">
                    ...
                    <div class="mt-2 px-7 py-3">
                        <p class="text-sm text-gray-600 mb-3">
                            <span class="text-red-500">*</span> Campo necesario</p>
                        <form id="form-tipopago" action="<?php echo e(route('tipo_pago.insertar')); ?>" method="post">
                            <?php echo csrf_field(); ?>
                            <div class="mb-4">
...
</html><?php /**PATH C:\Users\Usuario\Downloads\SGN_Monalezza-main\SGN_Monalezza-main\resources\views/ventas.blade.php ENDPATH**/ ?>