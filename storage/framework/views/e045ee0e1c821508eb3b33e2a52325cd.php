        ...
        <div class="flex-grow overflow-y-auto p-4">
            ...
            <div class="bg-white shadow-md rounded-lg p-4">
                ...
                <div data-modal="modal-filtros" style="display: none;" class="fixed inset-0 bg-black bg-opacity-50 items-center justify-center z-50 flex">
                    <div class="bg-white w-full max-w-md rounded-lg shadow-lg p-6 relative">
                        ...
                        <form action="<?php echo e(route('reserva.filtrar')); ?>" method="GET" class="space-y-4">
                            <div>
                            ...
                            <div>
                                ...
                                <select name="cliente_fk" id="cliente_fk" class="w-full border border-gray-300 rounded px-3 py-2">
                                    ...
                                    <?php $__currentLoopData = $clientes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cliente): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($cliente->cliente_pk); ?>" <?php echo e(request('cliente_fk') == $cliente->cliente_pk ? 'selected' : ''); ?>>
                            ...
                            <div>
                                ...
                                <select name="estatus" id="estatus" class="w-full border border-gray-300 rounded px-3 py-2">
                                    ...
                                    <option value="1" <?php echo e(request('estatus') == '1' ? 'selected' : ''); ?>>Pendientes</option>
                                    <option value="0" <?php echo e(request('estatus') == '0' ? 'selected' : ''); ?>>Atendidas</option>
                                    <option value="2" <?php echo e(request('estatus') == '2' ? 'selected' : ''); ?>>Canceladas</option>
                                </select>
                            </div>
                            ...
                            <div class="flex justify-between items-center pt-2">
                                ...
                                <a href="<?php echo e(route('reserva.mostrar')); ?>" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded">
                                    Quitar filtros
                                </a>
                ...
                <table id="tabla-reservas" class="w-full">
                    ...
                    <tbody>
                        <?php $__currentLoopData = $datosReserva; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dato): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="border-b cursor-pointer" title="CLIC PARA VER DETALLES" 
                                data-mesas='<?php echo json_encode($dato->mesas, 15, 512) ?>'>
                                <td class="py-2"><?php echo e($dato->cliente->nombre_cliente); ?></td>
                                <td class="py-2"><?php echo e($dato->fecha_hora_reserva); ?></td>
                                <?php if( $dato->notas ): ?>
                                    <td class="py-2"><?php echo e($dato->notas); ?></td>
                                <?php else: ?>
                                    <td class="py-2"><em>Sin notas</em></td>
                                <?php endif; ?>
                                <?php if( $dato->estatus_reserva == 1 ): ?>
                                    <td class="py-2">Pendiente</td>
                                <?php elseif( $dato->estatus_reserva == 0 ): ?>
                                    <td class="py-2">Atendida</td>
                                <?php elseif( $dato->estatus_reserva == 2 ): ?>
                                    <td class="py-2">Cancelada</td>
                                <?php else: ?>
                                    <td class="py-2"><em>Sin estatus aplicado</em></td>
                                <?php endif; ?>
                                <td class="text-right py-2">
                                    <a href="<?php echo e(route('reserva.datosParaEdicion', $dato->reserva_pk)); ?>" class="bg-blue-500 text-white px-2 py-1 rounded fix">Editar</a>

                                    <?php if( $dato->estatus_reserva == 1 ): ?>
                                        <a href="<?php echo e(route('reserva.atendida', $dato->reserva_pk)); ?>" onclick="confirmarAtencion(event)" class="bg-green-500 text-white px-2 py-1 rounded fix">Atendida</a>
                                    <?php endif; ?>

                                    <?php if( $dato->estatus_reserva != 2 ): ?>
                                        <a href="<?php echo e(route('reserva.cancelada', $dato->reserva_pk)); ?>" onclick="confirmarCancelacion(event)" class="bg-red-500 text-white px-2 py-1 rounded fix">Cancelar</a>
                                    <?php elseif( $dato->estatus_reserva == 2 ): ?>
                                        <a href="<?php echo e(route('reserva.pendiente', $dato->reserva_pk)); ?>" onclick="confirmarDesCancelacion(event)" class="bg-black text-white px-2 py-1 rounded fix">Deshacer cancelación</a>
                                    <?php endif; ?>
                                </td>
                            </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="bg-white shadow-md rounded-lg p-4">
                <table id="tabla-reservas" class="w-full">
                    ...
                    <tbody>
                        <?php $__currentLoopData = $datosMesa; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dato): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="border-b cursor-pointer">
                                <td class="py-2"><?php echo e($dato->numero_mesa); ?></td>
                                <?php if( $dato->ubicacion ): ?>
                                    <td class="py-2"><?php echo e($dato->ubicacion); ?></td>
                                <?php else: ?>
                                    <td class="py-2"><em>Sin ubicación</em></td>
                                <?php endif; ?>
                                <?php if( $dato->estatus_mesa == 1 ): ?>
                                ...
                                <?php if( session('rol_pk') == 1 ): ?>
                                    <td class="text-right py-2">
                                        <a href="<?php echo e(route('mesa.datosParaEdicion', $dato->mesa_pk)); ?>" class="bg-blue-500 text-white px-2 py-1 rounded mr-2">Editar</a>

                                        <?php if($dato->estatus_mesa == 1): ?>
                                            <a href="<?php echo e(route('mesa.baja', $dato->mesa_pk)); ?>" onclick="confirmarBajaMesa(event)" class="bg-red-500 text-white px-2 py-1 rounded">Dar de baja</a>
                                        <?php else: ?>
                                            <a href="<?php echo e(route('mesa.alta', $dato->mesa_pk)); ?>" onclick="confirmarAltaMesa(event)" class="bg-green-500 text-white px-2 py-1 rounded">Dar de alta</a>
                                        <?php endif; ?>
                                    </td>
                                <?php endif; ?>
                            </tr>
            ...
            <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
                <div class="mt-3 text-center">
                    ...
                    <div class="mt-2 px-7 py-3">
                        ...
                        <form id="form-reserva" action="<?php echo e(route('reserva.insertar')); ?>" method="post">
                            <?php echo csrf_field(); ?>
                            <div class="mb-4">
                                ...
                                <select name="cliente_fk" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" required>
                                    ...
                                    <?php $__currentLoopData = $clientes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dato): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($dato->cliente_pk); ?>"><?php echo e($dato->nombre_cliente); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                            <div class="mb-4">
                                    ...
                                    <div class="flex items-center mb-2">
                                        <div class="flex flex-col w-3/4">
                                            ...
                                            <select name="mesas[]" class="w-full rounded-md border-gray-300 mb-2" required>
                                                ...
                                                <?php $__currentLoopData = $mesas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dato): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($dato->mesa_pk); ?>"><?php echo e($dato->numero_mesa); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                        </div>
            ...
            <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
                <div class="mt-3 text-center">
                    ...
                    <div class="mt-2 px-7 py-3">
                        <p class="text-sm text-gray-600 mb-3">
                            <span class="text-red-500">*</span> Campo necesario</p>
                        <form id="form-mesa" action="<?php echo e(route('mesa.insertar')); ?>" method="post">
                            <?php echo csrf_field(); ?>
                            <div class="mb-4">
...
</html><?php /**PATH C:\Users\Usuario\Downloads\SGN_Monalezza-main\SGN_Monalezza-main\resources\views/reservas.blade.php ENDPATH**/ ?>