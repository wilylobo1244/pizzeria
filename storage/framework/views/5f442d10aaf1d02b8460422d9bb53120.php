                ...
                <table id="tabla-proveedores" class="w-full">
                    ...
                    <tbody>
                        <?php $__currentLoopData = $datosProveedor; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dato): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="border-b">
                                <td class="py-2"><?php echo e($dato->nombre_proveedor); ?></td>
                                <?php if( $dato->estatus_proveedor == 1 ): ?>
                                    <td class="py-2">Activo</td>
                                <?php else: ?>
                                    <td class="py-2">Inactivo</td>
                                <?php endif; ?>
                                <td class="text-right py-2">
                                    <a href="<?php echo e(route('proveedor.datosParaEdicion', $dato->proveedor_pk)); ?>" class="bg-blue-500 text-white px-2 py-1 rounded mr-2">Editar</a>

                                    <?php if($dato->estatus_proveedor == 1): ?>
                                        <a href="<?php echo e(route('proveedor.baja', $dato->proveedor_pk)); ?>" onclick="confirmarBaja(event)" class="bg-red-500 text-white px-2 py-1 rounded">Dar de baja</a>
                                    <?php else: ?>
                                        <a href="<?php echo e(route('proveedor.alta', $dato->proveedor_pk)); ?>" onclick="confirmarAlta(event)" class="bg-green-500 text-white px-2 py-1 rounded">Dar de alta</a>
                                    <?php endif; ?>
                                </td>
                            </tr>
            ...
            <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
                <div class="mt-3 text-center">
                    ...
                    <div class="mt-2 px-7 py-3">
                        ...
                        <form id="form-proveedor" action="<?php echo e(route('proveedor.insertar')); ?>" method="post">
                            <?php echo csrf_field(); ?>
                            <div class="mb-4">
...
</html><?php /**PATH C:\Users\Usuario\Downloads\SGN_Monalezza-main\SGN_Monalezza-main\resources\views/proveedores.blade.php ENDPATH**/ ?>