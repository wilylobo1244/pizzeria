        ...
        <div class="flex-grow overflow-y-auto p-4">
                ...
                <table id="tabla-ingredientes" class="w-full">
                    ...
                    <tbody>
                        <?php $__currentLoopData = $datosIngrediente; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dato): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="border-b">
                                <td class="py-2"><?php echo e($dato->nombre_ingrediente); ?></td>
                                <td class="py-2"><?php echo e($dato->tipo_ingrediente->nombre_tipo_ingrediente); ?></td>
                                <?php if( $dato->estatus_ingrediente == 1 ): ?>
                                    <td class="py-2">Activo</td>
                                <?php else: ?>
                                    <td class="py-2">Inactivo</td>
                                <?php endif; ?>
                                <td class="text-right py-2">
                                    <a href="<?php echo e(route('ingrediente.datosParaEdicion', $dato->ingrediente_pk)); ?>" class="bg-blue-500 text-white px-2 py-1 rounded mr-2">Editar</a>

                                    <?php if($dato->estatus_ingrediente): ?>
                                        <a href="<?php echo e(route('ingrediente.baja', $dato->ingrediente_pk)); ?>" onclick="confirmarBajaIngrediente(event)" class="bg-red-500 text-white px-2 py-1 rounded">Dar de baja</a>
                                    <?php else: ?>
                                        <a href="<?php echo e(route('ingrediente.alta', $dato->ingrediente_pk)); ?>" onclick="confirmarAltaIngrediente(event)" class="bg-green-500 text-white px-2 py-1 rounded">Dar de alta</a>
                                    <?php endif; ?>
                                </td>
                            </tr>
            ...
            <div class="bg-white shadow-md rounded-lg p-4">
                <table id="tabla-tipo-ingrediente" class="w-full">
                    ...
                    <tbody>
                        <?php $__currentLoopData = $datosTipo_ingrediente; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dato): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="border-b cursor-pointer">
                                <td class="py-2"><?php echo e($dato->nombre_tipo_ingrediente); ?></td>
                                <?php if( $dato->estatus_tipo_ingrediente == 1 ): ?>
                                    <td class="py-2">Activo</td>
                                <?php else: ?>
                                    <td class="py-2">Inactivo</td>
                                <?php endif; ?>
                                <td class="text-right py-2">
                                    <a href="<?php echo e(route('tipo_ingrediente.datosParaEdicion', $dato->tipo_ingrediente_pk)); ?>" class="bg-blue-500 text-white px-2 py-1 rounded mr-2">Editar</a>

                                    <?php if($dato->estatus_tipo_ingrediente == 1): ?>
                                        <a href="<?php echo e(route('tipo_ingrediente.baja', $dato->tipo_ingrediente_pk)); ?>" onclick="confirmarBajaTipoIngrediente(event)" class="bg-red-500 text-white px-2 py-1 rounded">Dar de baja</a>
                                    <?php else: ?>
                                        <a href="<?php echo e(route('tipo_ingrediente.alta', $dato->tipo_ingrediente_pk)); ?>" onclick="confirmarAltaTipoIngrediente(event)" class="bg-green-500 text-white px-2 py-1 rounded">Dar de alta</a>
                                    <?php endif; ?>
                                </td>
                            </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
                <div class="mt-3 text-center">
                    ...
                    <div class="mt-2 px-7 py-3">
                        ...
                        <form id="form-ingrediente" action="<?php echo e(route('ingrediente.insertar')); ?>" method="post">
                            <?php echo csrf_field(); ?>
                            <div class="mb-4">
                            ...
                            <div class="mb-4">
                                ...
                                <select name="tipo_ingrediente_fk" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" required>
                                    ...
                                    <?php $__currentLoopData = $tiposIngrediente; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dato): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($dato->tipo_ingrediente_pk); ?>"><?php echo e($dato->nombre_tipo_ingrediente); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
            ...
            <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
                <div class="mt-3 text-center">
                    ...
                    <div class="mt-2 px-7 py-3">
                        <p class="text-sm text-gray-600 mb-3">
                            <span class="text-red-500">*</span> Campo necesario</p>
                        <form id="form-tipoingrediente" action="<?php echo e(route('tipo_ingrediente.insertar')); ?>" method="post">
                            <?php echo csrf_field(); ?>
                            <div class="mb-4">
...
</html><?php /**PATH C:\Users\Usuario\Downloads\SGN_Monalezza-main\SGN_Monalezza-main\resources\views/ingredientes.blade.php ENDPATH**/ ?>