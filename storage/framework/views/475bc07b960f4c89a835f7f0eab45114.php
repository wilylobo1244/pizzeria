        ...
        <div class="flex-grow overflow-y-auto p-4">
            ...
            <div class="bg-white shadow-md rounded-lg p-4">
                <table id="tabla-clientes" class="w-full">
                    ...
                    <tbody>
                        <?php $__currentLoopData = $datosCliente; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dato): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="border-b">
                            <td class="py-2"><?php echo e($dato->nombre_cliente); ?></td>
                            <td class="py-2">
                                Calle <?php echo e($dato->domicilio->calle); ?>, #<?php echo e($dato->domicilio->numero_externo); ?> externo
                                <?php if($dato->domicilio->numero_interno): ?>
                                    , #<?php echo e($dato->domicilio->numero_interno); ?> interno
                                <?php endif; ?>
                            </td>
                            <td class="py-2">
                                <?php if($dato->domicilio->referencias): ?>
                                    <?php echo e($dato->domicilio->referencias); ?>

                                <?php else: ?>
                                    <em>Sin referencias</em>
                                <?php endif; ?>
                            </td>
                            <td class="py-2"><?php echo e($dato->telefono->telefono); ?></td>
                            <?php if( session('rol_pk') == 1 ): ?>
                                <td class="text-right py-2">
                                    <a href="<?php echo e(route('cliente.datosParaEdicion', $dato->cliente_pk)); ?>" class="bg-blue-500 text-white px-2 py-1 rounded mr-2">Editar</a>
                                </td>
                            <?php endif; ?>
                        </tr>
            ...
            <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
                <div class="mt-3 text-center">
                    ...
                    <div class="mt-2 px-7 py-3">
                        ...
                        <form id="form-cliente" action="<?php echo e(route('cliente.insertar')); ?>" method="post">
                            <?php echo csrf_field(); ?>
                            <div class="mb-4">
...
</html><?php /**PATH C:\Users\Usuario\Downloads\SGN_Monalezza-main\SGN_Monalezza-main\resources\views/clientes.blade.php ENDPATH**/ ?>