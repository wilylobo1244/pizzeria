    ...
    <div class="main-container">
        <div class="content-container">
            ...
            <div class="left-column bg-white shadow-lg rounded-lg p-6 w-full md:w-1/2 lg:w-1/3">
                <form action="<?php echo e(route('pedido.insertar')); ?>" method="POST" class="space-y-4 h-full flex flex-col">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="space-y-4 overflow-y-auto flex-3 pb-8">
                        ...
                        <div>
                            ...
                            <select name="cliente_fk" id="cliente_fk" data-control="select2" data-placeholder="Cliente genérico o Selecciona un cliente">
                                ...
                                <?php $__currentLoopData = $clientes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cliente): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($cliente->cliente_pk); ?>"><?php echo e($cliente->nombre_cliente); ?></option>
                        ...
                        <div>
                            ...
                            <input type="text" value="<?php echo e($USUARIO); ?>" class="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" readonly>
                        </div>
                        ...
                        <div>
                            ...
                            <select name="medio_pedido_fk" id="medio_pedido" class="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" required>
                                ...
                                <?php $__currentLoopData = $mediosPedido; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $medio): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($medio->medio_pedido_pk); ?>"><?php echo e($medio->nombre_medio_pedido); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                        ...
                        <div>
                            ...
                            <select name="tipo_pago_fk" id="tipo_pago_fk" class="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" required>
                                ...
                                <?php $__currentLoopData = $tiposPago; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tipo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($tipo->tipo_pago_pk); ?>"><?php echo e($tipo->nombre_tipo_pago); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="number" name="pago" id="pago" value="<?php echo e(old('pago')); ?>" min="0" class="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" required>
                        </div>

                        <div>
                            <label for="cambio" class="block font-medium mb-2">Cambio</label>
                            <input type="number" id="cambio" name="cambio" value="<?php echo e(old('cambio')); ?>" class="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" readonly>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="datetime-local" name="fecha_hora_pedido" id="fecha_hora_pedido" value="<?php echo e(Carbon::now()->format('Y-m-d\TH:i')); ?>" class="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" required>
                        </div>
                ...
                <div id="product-container" class="menu-grid">
                    <?php $__currentLoopData = $productos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $producto): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="menu-item relative bg-cover bg-center text-white p-4 rounded-lg shadow-md cursor-pointer"
                            style="background-image: url('<?php echo e(asset($producto->imagen_producto ?? 'img/sin-imagen.jpg')); ?>');"
                            data-nombre="<?php echo e($producto->nombre_producto); ?>" 
                            data-tipo="<?php echo e($producto->tipo_producto->nombre_tipo_producto); ?>" 
                            data-precio="<?php echo e($producto->precio_producto); ?>" 
                            data-personalizable="<?php echo e($producto->personalizable); ?>" 
                            onclick="toggleProductSelection(this, <?php echo e($producto->producto_pk); ?>, '<?php echo e($producto->nombre_producto); ?>', <?php echo e($producto->precio_producto); ?>, '<?php echo e($producto->tipo_producto->nombre_tipo_producto); ?>')">
                            <div class="absolute inset-0 bg-black bg-opacity-50 rounded-lg"></div>
                            <input type="checkbox" name="producto_fk[]" value="<?php echo e($producto->producto_pk); ?>" class="relative z-10">
                            <div class="relative z-5 font-bold text-lg"><?php echo e($producto->nombre_producto); ?></div>
                            <div class="relative z-5 text-sm"><?php echo e($producto->tipo_producto->nombre_tipo_producto); ?></div>
                            <div class="relative z-5 font-semibold">$<?php echo e($producto->precio_producto); ?></div>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
                <div class="info-buttons">
                    <a href="<?php echo e(route('producto.mostrar')); ?>">
                        <div class="info-button products-registered less">
                            Productos registrados 🍕
                        </div>
                    </a>
                    <a href="<?php echo e(route('pedido.mostrar')); ?>">
                        <div class="info-button total-sales less">
                            Total ventas 💰
                        </div>
                    </a>
                    <a href="<?php echo e(route('reserva.filtrar', ['fecha' => now()->toDateString()])); ?>">
                        <div class="info-button profits relative less">
                            Reservaciones 🕐
                            <?php if(isset($cantidadReservasHoy) && $cantidadReservasHoy > 0): ?>
                                <span class="absolute top-0 left-0 bg-green-700 text-white text-xs font-bold rounded-full px-2 py-1">
                                    <?php echo e($cantidadReservasHoy); ?>

                                </span>
                            <?php endif; ?>
                        </div>
                    </a>
                    <a href="<?php echo e(route('inventario.filtrar', ['estado' => 'riesgo'])); ?>">
                        <div class="info-button low-stock relative less">
                            Inventario poco Stock 📉
                            <?php if(isset($cantidadCritico) && $cantidadCritico > 0): ?>
                                <span class="absolute top-0 left-0 bg-red-700 text-white text-xs font-bold rounded-full px-2 py-1">
                                    <?php echo e($cantidadCritico); ?>
                                ...
                                <?php $__currentLoopData = $datosIngrediente; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dato): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="space-y-1 border rounded p-2">
                                        <label class="flex items-center space-x-2">
                                            <input type="checkbox" class="checkbox-ingrediente" data-id="<?php echo e($dato->ingrediente_pk); ?>">
                                            <span class="text-sm text-gray-800"><?php echo e($dato->nombre_ingrediente); ?></span>
                                        </label>
                                        <input type="number" class="cantidad-ingrediente w-full border-gray-300 rounded text-sm" 
                                            data-id="<?php echo e($dato->ingrediente_pk); ?>" 
                ...
                <div class="relative z-50 top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
                    <div class="mt-3 text-center">
                        ...
                        <div class="mt-2 px-7 py-3">
                            ...
                            <form id="form-efectivoInicial" action="<?php echo e(route('entradas_caja.efectivoInicial')); ?>" method="POST">
                                <?php echo csrf_field(); ?>
                                <div class="mb-4">
            ...
            <script>
                document.addEventListener("DOMContentLoaded", function () {
                    ...
                    const registroHoy = <?php echo json_encode($registroHoy, 15, 512) ?>; // viene desde PHP
                    const hoy = <?php echo json_encode($hoy, 15, 512) ?>;
            ...
            <?php if(Session::has('pedido_exitoso')): ?>
                <script>
                    Swal.fire({
                        icon: 'success',
                        text: '<?php echo e(Session::get('pedido_exitoso')); ?>',
                        confirmButtonText: 'Ver Ticket',
                        allowOutsideClick: false,
                    }).then((result) => {
                        if (result.isConfirmed) {
                            const win = window.open("<?php echo e(route('ticket.mostrar', ['pedido_pk' => Session::get('pedido_pk')])); ?>", "_blank");
                        }
                    });
                </script>
            <?php endif; ?>

            <?php if(Session::has('falta_stock')): ?>
                <script>
                    Swal.fire({
                        icon: 'warning',
                        text: '<?php echo e(Session::get('falta_stock')); ?>',
                        confirmButtonText: 'Ver Ticket',
                        allowOutsideClick: false,
                    }).then((result) => {
                        if (result.isConfirmed) {
            ...
            <?php if(Session::has('registro_error')): ?>
                <script>
                    Swal.fire({
                        icon: 'error',
                        text: '<?php echo e(Session::get('registro_error')); ?>',
...
<?php /**PATH C:\Users\Usuario\Downloads\SGN_Monalezza-main\SGN_Monalezza-main\resources\views/inicio.blade.php ENDPATH**/ ?>