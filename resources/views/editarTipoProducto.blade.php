...
<head>
    ...
    <title>Edición de Tipo de Producto - La Monalezza</title>
    {{-- Tailwind --}}
...
<body class="h-full bg-gray-100 overflow-hidden">
    ...
    <div class="h-screen flex flex-col">
        ...
        <div class="flex-grow overflow-y-auto p-4">
            <h1 class="text-2xl font-bold mb-4">Edición de Tipo de Producto</h1>
            <div class="bg-white shadow-md rounded-lg p-4">
                <form action="{{ route('tipo_producto.actualizar', $datosTipo_producto->tipo_producto_pk) }}" method="post">
                    @csrf
                    @method('put')
